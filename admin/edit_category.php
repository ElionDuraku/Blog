        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-9">
                ...
                <div class="card-header">
                    <h3 class="text-center font-weight-light my-2">Update Category</h3>
                </div>
                ...
                <div class="card-body">
                    <form method="post" action="">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control py-4" value="<?php echo $category->getName();?>"
                            name="name" id="name" type="text" placeholder="Enter category name" />
                        </div>
                        <div class="form-group">
                            <label class="small mb-1" for="description">Description :</label>
                            <input class="form-control py-4" name="description" value="<?php echo $category->getDescription();?>"
                            id="description" type="text" placeholder="Enter description" />
                        </div>
                        
                        <input class="btn btn-primary"  id="login" value="Update Category"  
