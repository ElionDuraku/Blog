            ...
            <div class="col-lg-9">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control py-4" readonly value="<?php echo $post->getTitle();?>" 
                            name="title" id="title" type="text" placeholder="Enter title" />
                    </div>
                    <div class="form-group">
                        <label class="small mb-1" for="content">Content:</label>
                        <input class="form-control py-4" readonly name="content" value="<?php echo $post->getContent();?>"
                            id="content" type="text" placeholder="Enter content" />
                    </div>
                    <div class="form-group">
                        <label class="small mb-1" for="author">Author name:</label>
                        <input class="form-control py-4" readonly name="author" value="<?php echo $post->getAuthor();?>"
                            id="author" type="text" placeholder="Enter author name" />
                    </div>
                    <div class="form-group">
                        <label class="small mb-1" for="tags">Tags:</label>
                        <input class="form-control py-4" readonly name="tags" value="<?php echo $post->getTags();?>"
                            id="tags" type="text" placeholder="Enter tags" />
                    </div>
                    <div class="form-group">
                        <label class="small mb-1" for="data">Data:</label>
                        <input class="form-control py-4" readonly name="data" value="<?php echo $post->getData();?>"
                            id="data" type="data" placeholder="Enter Data" />
                    </div>

                        <input class="btn btn-primary"  id="login" value="Delete Post"  
                         type="submit" name="delete_post"/>
                    </form>
                </div>
